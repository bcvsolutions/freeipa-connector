...
import static eu.bcvsolutions.freeipa.connector.FreeIPAConstants.DISABLED_ATRIBUTE;
import static eu.bcvsolutions.freeipa.connector.FreeIPAConstants.FREE_IPA_USER_ATTRIBUTE;
import static eu.bcvsolutions.freeipa.connector.FreeIPAConstants.LOGIN_ATRIBUTE;
import static eu.bcvsolutions.freeipa.connector.FreeIPAConstants.MEMBER_OF_ATTRIBUTE;
import static eu.bcvsolutions.freeipa.connector.FreeIPAConstants.NS_ACCOUNT_LOCK_ATRIBUTE;
import static eu.bcvsolutions.freeipa.connector.FreeIPAConstants.RENAME_ATTRIBUTE;
import static eu.bcvsolutions.freeipa.connector.FreeIPAConstants.SPECIAL_ATTRIBUTES;
import static eu.bcvsolutions.freeipa.connector.FreeIPAConstants.UID_ATRIBUTE;
...
import eu.bcvsolutions.freeipa.post.group.AddMemberGroupServicePost;
import eu.bcvsolutions.freeipa.post.group.RemoveMemberGroupServicePost;
import eu.bcvsolutions.freeipa.post.user.AddUserServicePost;
import eu.bcvsolutions.freeipa.post.user.DeleteUserServicePost;
import eu.bcvsolutions.freeipa.post.user.DisableUserServicePost;
import eu.bcvsolutions.freeipa.post.user.EnableUserServicePost;
import eu.bcvsolutions.freeipa.post.user.FindUserServicePost;
import eu.bcvsolutions.freeipa.post.user.UpdateUserServicePost;
